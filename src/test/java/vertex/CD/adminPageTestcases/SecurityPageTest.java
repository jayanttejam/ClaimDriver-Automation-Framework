...
import vertex.CD.AdminPages.SecurityPage;
...
public void verify_Security_Page_Title_Test() throws InterruptedException{
	securityPage.click_On_Security_Page();
	String adminPageTitle = securityPage.verify_Security_Page_Title();
	Assert.assertEquals(adminPageTitle, "Security Tools | ClaimDriver");
}

@Test(priority=2, enabled=true)
public void verify_Security_Page_Loaded_Test() throws InterruptedException{
	securityPage.click_On_Security_Page();
	
	boolean result = securityPage.verify_Security_Page_Loaded();
