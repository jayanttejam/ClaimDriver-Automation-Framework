...
public class RulesPage extends TestBase{
	...
	//Page factory - OR
		...
		@FindBy(xpath="//a[contains(text(),'All Rules')]")
		WebElement allRules;
		...
		public void click_On_Rules_Page() throws InterruptedException {
		...
		public boolean verify_Rules_Page_Loaded(){
			
		boolean isPresent = allRules.isDisplayed();
		return isPresent;
		}
				
		public String verify_Rules_Page_Title(){
