...
public class ReBrandNewWorkOrderPage extends TestBase{
	...
	//Page factory - OR
		...
		@FindBy(xpath="//a[contains(text(),'Collision Invoice')]")
		WebElement CollisionInvTab;
		...
		// Estimate Overview OR
		
		@FindBy(xpath="//input[@id='VehYear']")
		WebElement vehYear;
		
		@FindBy(xpath="//input[@id='VehMake']")
		WebElement vehMake;
		
		@FindBy(xpath="//input[@id='VehModel']")
		WebElement vehModel;
		
		@FindBy(xpath="//input[@id='DecalRemoval']")
		WebElement decalRemoval;
		
		@FindBy(xpath="//input[@id='OverallPaint']")
		WebElement overallPaint;
		
		@FindBy(xpath="//input[@id='DecalInstall']")
		WebElement decalInstall;
		
		@FindBy(xpath="//input[@id='BodyRepair']")
		WebElement bodyRepair;
		
		@FindBy(xpath="//input[@id='EstTax']")
		WebElement estTax;
		
		@FindBy(xpath="//input[@id='Supplement']")
		WebElement supplement;
		
		@FindBy(xpath="//input[@id='SuppTax']")
		WebElement suppTax;
		
		@FindBy(xpath="//input[@id='btnPDFtoJournal']")
		WebElement submit1;
		
		//Quality Inspection Checklist OR
		
		@FindBy(xpath="//a[normalize-space()='Alsco Quality Inspection Checklist']")
		WebElement QualityInspChklst;
		
		
		@FindBy(xpath="//select[@id='cbPaint']")
		WebElement cbPaint;
		
		@FindBy(xpath="//select[@id='cbPaint2']")
		WebElement cbPaint2;
		
		@FindBy(xpath="//select[@id='cbPaint3']")
		WebElement cbPaint3;
		
		@FindBy(xpath="//select[@id='cbPaint4']")
		WebElement cbPaint4;
		
		@FindBy(xpath="//select[@id='cbPaint5']")
		WebElement cbPaint5;
		
		@FindBy(xpath="//select[@id='cbPaint6']")
		WebElement cbPaint6;
		
		@FindBy(xpath="//select[@id='cbBody']")
		WebElement cbBody;
		
		@FindBy(xpath="//select[@id='cbBody2']")
		WebElement cbBody2;
		
		@FindBy(xpath="//select[@id='cbBody3']")
		WebElement cbBody3;
		
		@FindBy(xpath="//select[@id='cbBody4']")
		WebElement cbBody4;
		
//		@FindBy(xpath="//select[@id='SubmittedBy']")
//		WebElement submittedBy;
//		
//		@FindBy(xpath="//select[@id='ApprovedBy']")
//		WebElement approvedBy;
		
		
		// Initializing the Page Objects:
		
		public ReBrandNewWorkOrderPage() {
		...
		public ReBrandNewWorkOrderPage VerifyclickOnNewFile() throws InterruptedException{
			filesMainMenu.click();
			
			Thread.sleep(2000);
			newFile.click();
			Thread.sleep(2000);
			return new ReBrandNewWorkOrderPage();
		}
		...
		public void selectValueFromDropDown(WebElement field) {
		...
		public void fillDataInEstimateForm() throws InterruptedException {
//			asssetNumber.sendKeys(astNo);
//			vin.sendKeys(vinNo);
//			Thread.sleep(2000);
			vehYear.sendKeys("2020");
			vehMake.sendKeys("TestMake");
			vehModel.sendKeys("TestModel");
			decalRemoval.sendKeys("1");
			overallPaint.sendKeys("1");
			decalInstall.sendKeys("1");
			bodyRepair.sendKeys("1");
			estTax.sendKeys("1");
			supplement.sendKeys("1");
			suppTax.sendKeys("1");
		...
		public void fillDataInQualityInspectionChecklistForm() throws InterruptedException {
			
			forms.click();
			Thread.sleep(1000);
			QualityInspChklst.click();
			Thread.sleep(1000);
			selectValueFromDropDown(cbPaint);
			selectValueFromDropDown(cbPaint2);
			selectValueFromDropDown(cbPaint3);
			selectValueFromDropDown(cbPaint4);
			selectValueFromDropDown(cbPaint5);
			selectValueFromDropDown(cbPaint6);
			Thread.sleep(1000);
			selectValueFromDropDown(cbBody);
			selectValueFromDropDown(cbBody2);
			selectValueFromDropDown(cbBody3);
			selectValueFromDropDown(cbBody4);
			Thread.sleep(1000);
			SubmittedBy.sendKeys("TestSubmit");
			ApprovedBy.sendKeys("TestApproved");
			Thread.sleep(1000);
			submit1.click();
			Thread.sleep(2000);
		}
		...
		public void fillDataInCollisionInvoice(String invNo,String autNo,String autNo2,String date,String part,String bodyLB, String paintLB, String mechLB,String frameLB,String paintMTL, String sublt,String othr,String saleTax,String subBy) throws Exception {
			...
			// js.executeScript("javascript:window.scrollBy(500,500)");
			 Thread.sleep(1000);
			//TestUtil.selectDate(driver, date); //working method
