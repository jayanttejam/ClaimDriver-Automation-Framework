...
public class NewWorkOrderPage extends TestBase{
	...
	//Page factory - OR
		...
		@FindBy(xpath="//label[contains(text(),'I Acknowledge')]")
		...
		public NewWorkOrderPage VerifyclickOnNewFile() throws InterruptedException{
			filesMainMenu.click();
			
			Thread.sleep(2000);
			newFile.click();
			Thread.sleep(2000);
			return new NewWorkOrderPage();
		}
