...
public class DirectorySearchPage extends TestBase{
	...
	//Page factory - OR
		...
		public DirectorySearchPage VerifyclickOnNewFile() throws InterruptedException{
			filesMainMenu.click();
			
			Thread.sleep(2000);
			newFile.click();
			Thread.sleep(3000);
			return new DirectorySearchPage();
		}
